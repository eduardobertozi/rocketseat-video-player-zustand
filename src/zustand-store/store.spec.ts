...
const initalState = store.getState() // Desta forma será considerado apenas o estado inicial do store

describe('zustend store', () => {
  beforeEach(() => {
    store.setState(initalState) // A cada teste ele substitui o estado com o valor inicial
  })
  ...
  it('should not update the current module and lesson index if there s no next lesson available', () => {
    store.setState({ course })
